...
export type Exercise = { exercise_id: string; nome: string; musculo_principal: string; musculos_secundarios: string[]; descanso_seg: number; previous?: string; sets: Series[] };
